##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.7.0-B52] date: [Sat Jul 26 19:53:45 PDT 2025]
##########################################################################################################################
...
flash: all
	openocd -f interface/stlink-dap.cfg -f target/stm32h5x.cfg -c "program build/$(TARGET).elf verify reset exit"
